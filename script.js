document.addEventListener('DOMContentLoaded', function() {
  ...
  if (animatedElements.length > 0) {
    ...
    style.textContent = '.fade-in.animated, [data-animate="fade-in"].animated { opacity: 1 !important; transform: translateY(0) !important; }';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Aviv Art משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'a107d125-b7c6-4629-992f-531d60556b3e',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'a107d125-b7c6-4629-992f-531d60556b3e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'a107d125-b7c6-4629-992f-531d60556b3e';
